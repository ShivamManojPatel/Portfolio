...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Use vw-based maxWidth so it fits any screen
    const nameWidth = Math.min(window.innerWidth * 0.7, 220);
    setTimeout(() => {
        lHivam.style.maxWidth = nameWidth + "px";
        lHivam.style.opacity = "1";
        lAtel.style.maxWidth = nameWidth + "px";
        lAtel.style.opacity = "1";
        lSpace.style.width = "10px";
        lS.style.transform = "translateX(0)";
        lP.style.transform = "translateX(0)";
        loaderStatus.textContent = "// ready";
    }, 2500);

    // Step 4 — Slide loader UP to reveal page
    setTimeout(() => {
